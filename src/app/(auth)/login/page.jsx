...
export default function LoginPage() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // User + token + login status save
            login(user, token);


            // Sabhi roles ke liye same existing dashboard
            ...
            <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white px-7 py-6 shadow-[0_12px_40px_rgba(15,23,42,0.12)]">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-lg bg-blue-600 py-2.5 text-sm font-semibold text-white shadow-md shadow-blue-200 transition hover:bg-blue-700 hover:shadow-lg active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
                    >
